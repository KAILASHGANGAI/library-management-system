...
if (isset($_POST['add_book'])) {
  if (empty($_POST['book_name'])) {
      ...
      $message = "<p style='color:red; font-size:20px; text-aline:center;'>Please enter the price!!</p>";
    ...
    if (empty($message)) {
      ...
      $sql ="INSERT INTO `books` ( `book_name`, `book_no`, `auther`, `publication`, `price`, `edition`) VALUES ( '$book_name', '$book_no', '$auther', '$publication', '$price', '$edition')";

      if(mysqli_query($connect , $sql)){
        $result = "<p style='font-size: 20px; color:green;'>Book added successfully</p>";
        header('location:view_total_books.php');       
      }else{
        $result = "<p style='font-size: 20px; color:red;'>Book not added successfully</p>".mysqli_error($connect);
      }
    }
  }
}
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Add Books</a>
          </div>
              ...
              <form method="post" action="">
                <div class="row">
                  ...
                  <div class="row">
                    <div class=" pl-1 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter auther name" name="auther">
                      </div>
                    </div>
                    ...
                    <div class=" pl-1 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder=" Edition of book" name="edition">
                      </div>
                    </div>
                       <div class=" pl-1 col-md-6">
                         <div class="form-group">
                 ...
                 <div class="update ml-auto mr-auto">
                   <button type="submit" class="btn btn-primary btn-round" name="add_book">Add book</button>
                 </div>
              </form>
            </div>
          </div>
