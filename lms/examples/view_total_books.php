...
$sql ="SELECT * FROM `books` WHERE CONCAT(`id`, `book_name`, `book_no`, `auther`, `publication`, `price`, `edition`, `join_date`) LIKE '%".$search_item."%'";
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">View total books</a>
          </div>
                 ...
                 <table class="table">
                   ...
                   <tbody>
                     ...
                     <tr>
                       ...
                       <td>
                         <a href="edit_book.php?edit=<?php echo $row['id'];?>"><i class="flaticon-writing"></i></a>
                         <a href="view_total_books.php?delete=<?php echo $row['id'];?>" class="text-danger"><i class="flaticon-delete-1"></i></a>
                       </td>
                     </tr>
                     </tbody>
                    <?php endwhile; ?>
