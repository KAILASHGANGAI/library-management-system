...
if (isset($_POST['issue_book'])) {
  if (empty($_POST['book_name'])) {
    ...
    $price = $_POST['price'];
    if (empty($message)) {
      $sql= "INSERT INTO `issue` ( `book_name`, `book_no`, `Issue_by`, `price`) VALUES ('$book_name', '$book_no', '$issue_by', '$price')";
      $result = mysqli_query($connect, $sql);
      if ($result) {
          $message = "<p style='color:green; font-size:20px; text-aline:center;'>Book issued Successfully</p>";
          header('location:view_issued_books.php');
      }else{
          $message = "<p style='color:red; font-size:20px; text-aline:center;'>Book not issued Successfully !!</p>";
              ...
              <form method="post" action="">
                  ...
                  <div class=" pl-1">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder=" Book ID_NO" name="book_no">
                    </div>
                  </div>
                  ...
                  <div class=" pl-1">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter the member name who issue this book" name="issue_by">
                    </div>
                  </div>
                  ...
                  <div class=" pl-1">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" placeholder=" Enter the price of Book" name="price">
                    </div>
